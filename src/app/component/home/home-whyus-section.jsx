...
const comparisons = [
  { feature: "Custom strategy per client", us: true, others: false },
  ...
  { feature: "Same day response time", us: true, others: false },
  { feature: "No rigid annual contracts", us: true, others: false },
  { feature: "Quick implementation cycles", us: true, others: false },
  { feature: "Local Delhi market expertise", us: true, others: false },
];

const CheckIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E84D0E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export default function WhyUsSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 3D Tilt effect for reason cards
      cards.forEach(card => {
        let rect = null;
    ...
    <section ref={sectionRef} className="wcu-root">
      ...
      <div className="wcu-wrap">
        ...
        <div ref={headRef} className="wcu-header">
          ...
          <div className="clip-row">
            <h2 className="wcu-h2 wcu-reveal">How We Outperform</h2>
          </div>
          <div className="clip-row">
            <h2 className="wcu-h2 wcu-reveal"><em className="wcu-em">Every Other Agency</em></h2>
          </div>
          <div className="clip-row">
            <p className="wcu-desc wcu-reveal">
              Most agencies sell you packages. We deliver measurable outcomes. Here&apos;s the difference — side by side.
            </p>
          </div>
        </div>
        ...
        {/* Bold results strip – aligned with real services */}
        <div className="wcu-results-strip">
          {[
            { num: '100+', label: 'GBP Profiles Optimised' },
            { num: '6', label: 'Core Services' },
            { num: '4.8/5', label: 'Avg. client rating' },
            { num: '30 Day', label: 'First results visible' },
          ].map((r, i) => (
        ...
        {/* Reason cards – rewritten without ads */}
        <div ref={cardsRef} className="reasons-grid">
          {[
            {
              num: "01",
              title: "We Report Transparently",
              text: "Every month, a clear report lands in your inbox — rankings, traffic, leads, and real insights. No smoke and mirrors.",
            },
            {
              num: "02",
              title: "No Fixed Contracts",
              text: "We don't lock you into annual agreements. We earn your business every month with performance, not legal fine print.",
            },
            {
              num: "03",
              title: "We Know Delhi",
              text: "Local search dynamics, Hindi and English audience behaviour, hyperlocal trends — we understand what works here.",
            },
            {
              num: "04",
              title: "Fast Execution",
              text: "Your site up and running in 2 weeks. Automation workflows set up within 48 hours. Speed without cutting corners.",
            },
          ].map((r, i) => (
      ...
      <style jsx global>{`
        ...
        .wcu-desc {
          ...
          max-width: 500px; margin-top: 18px; display: block; opacity: 0;
        }
        ...
        .comp-thead-us { color: #fff; }
        .comp-thead-badge {
          background: #E84D0E; color: #fff;
        ...
        .comp-row:hover { background: rgba(255,255,255,0.018); }
        .comp-feature {
          font-family: 'Inter', sans-serif;
        ...
        .wcu-results-item:hover { background: rgba(232,77,14,0.03); }
        .wcu-results-num {
          font-family: 'Space Grotesk', sans-serif;
        ...
        .reason-num {
          ...
          color: #E84D0E; letter-spacing: 0.1em;
        ...
        @media (max-width: 900px) {
          .comp-thead { grid-template-columns: 1fr 120px 120px; }
          .comp-row { grid-template-columns: 1fr 120px 120px; }
          .reasons-grid { grid-template-columns: repeat(2, 1fr); }
        }
        @media (max-width: 600px) {
          .wcu-root { padding: 80px 0; }
          .wcu-wrap { padding: 0 20px; }
          .comp-thead { padding: 14px 16px; }
