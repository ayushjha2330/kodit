...
const services = [
  ...
  { label: "SEO Optimization", href: "/service" },
  { label: "GMB Optimization", href: "/service" },
  { label: "Graphic Design", href: "/service" },
  { label: "AI Automation", href: "/service" },
  { label: "Social Media", href: "/service" },
];

const socials = [
  {
    label: "Instagram",
    href: "https://instagram.com/koditagency",
    icon: (
  ...
  {
    label: "Discord",
    href: "https://discord.gg/koditagency",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/koditagency",
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-grid-wrap">
          ...
          <div className="footer-brand-col">
            ...
            <p className="footer-tagline">
              Delhi based growth partner for local businesses. We build brands that dominate — custom websites, SEO, GMB, AI automation, and design that delivers results.
            </p>
